...
public class JsonExceptionHandler extends DefaultErrorWebExceptionHandler {
     ...
     */
    public static Map<String, Object> buildErrorAttributes(int httpStatus, BaseResponse response) {
     ...
     * @return 异常信息
     */
    protected BaseResponse buildResponse(ServerRequest request, Throwable ex) {
